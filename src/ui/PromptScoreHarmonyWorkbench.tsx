...
import ChordCursorDebugPanel from '../debug/ChordCursorDebugPanel'
import RhythmTreeDebugPanel from '../debug/RhythmTreeDebugPanel'
import ScoreRenderer from './ScoreRenderer'
import { generateMusicBrainResult } from '../music/musicBrain'
...
const PALETTE_BY_MODE: Record<WorkspaceMode, PaletteGroup[]> = {
  compose: [
    { title: 'Rhythm', items: [{ label: 'Whole', glyph: '𝅝' }, { label: 'Half', glyph: '𝅗𝅥' }, { label: 'Quarter', glyph: '♩' }, { label: 'Eighth', glyph: '♪' }, { label: '16th', glyph: '♬' }, { label: 'Rest', glyph: '𝄽' }] },
